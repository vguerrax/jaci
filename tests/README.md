...
| [BL-0020](../docs/domain/backlog/items/BL-0020-bloquear-renomeacao-item-vinculado.md) Nome imutável para item vinculado | Em validação | `tests/test_business_rules.py`, `tests/test_collaboration_and_isolation_flow.py`, `tests/test_template_execution_flow.py`, `tests/test_offline_cache.py`, `tests/test_pwa.py` e `tests/test_sticky_budget.py`; cenário Playwright futuro relacionado à BL-0011 |
