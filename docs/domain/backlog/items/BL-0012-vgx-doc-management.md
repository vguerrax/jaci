...
- Validações: revisão documental inicial concluída; validações da skill ainda não iniciadas
- Publicação: ainda não publicada
- Itens relacionados: Moara `BL-0030`; Potira `BL-0010`

### Impedimentos

- Aprovação explícita do refinamento antes de criar ou alterar skills.
