...
| [BL-0013](items/BL-0013-filtrar-itens-lista-compra.md) | Filtrar itens nas telas de Lista e Compra | `melhoria` | `a_triar` | `a_definir` | `recebido` | `a_definir` | `2026-08-03` |
