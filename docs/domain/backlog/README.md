...
| [BL-0015](items/BL-0015-adicionar-item-comprado.md) | Adicionar item como comprado durante execução | `melhoria` | `a_triar` | `a_definir` | `recebido` | `a_definir` | `2026-08-03` |
