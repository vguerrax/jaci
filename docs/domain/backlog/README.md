...
| [BL-0015](items/BL-0015-adicionar-item-comprado.md) | Adicionar item como comprado durante execução | `melhoria` | `N/A` | `P2` | `pronto_para_implementacao` | Engenharia Jaci | `2026-08-04` |
