...
| [BL-0018](items/BL-0018-corrigir-backdrop-modal-completar-item.md) | Corrigir backdrop sobre o modal de completar item | `bug` | `S1` | `P0` | `em_validacao` | Engenharia Jaci | `2026-08-05` |
