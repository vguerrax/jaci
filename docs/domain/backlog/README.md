...
| [BL-0016](items/BL-0016-botao-flutuante-adicionar-itens.md) | Disponibilizar botão flutuante para adicionar itens | `melhoria` | `N/A` | `P2` | `em_implementacao` | Engenharia Jaci | `2026-08-04` |
