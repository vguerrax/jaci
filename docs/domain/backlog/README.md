...
| [BL-0014](items/BL-0014-fixar-orcamento-compra.md) | Fixar resumo de orçamento durante a compra | `melhoria` | `N/A` | `P2` | `pronto_para_implementacao` | Engenharia Jaci | `2026-08-03` |
